...
uniform int neighborhoodRadius = 1;
uniform bool tisToroidal = false;

uniform int birth = 3;
uniform int survivalMin = 3;
uniform int survivalMax = 5;
uniform int overpopulation = 6;

uniform int altbirth = 8;
